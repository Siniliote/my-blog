...
description: '🎃 Symfony 7.2 : Une Sortie Effrayante en Novembre ! 🎃'
...
Il est possible d'y ajouter des flags : - `Yaml::PARSE_CONSTANT` - `Yaml::PARSE_CUSTOM_TAGS` - `Yaml::PARSE_DATETIME`
